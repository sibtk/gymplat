      ...
      <div>
        ...
        <div className="grid grid-cols-1 gap-4 tablet:grid-cols-2">
          {aiRecommendations.map((rec) => (
            <div
              key={rec.id}
              className="rounded-xl border border-peec-border-light bg-white p-5 shadow-card transition-shadow hover:shadow-card-hover"
            >
      ...
      <div>
        ...
        <div className="grid grid-cols-1 gap-4 tablet:grid-cols-2">
          {weeklyAtRisk.map((member) => (
            <div
              key={member.id}
              className="rounded-xl border border-peec-border-light bg-white p-4"
            >
        ...
        <div className="grid grid-cols-1 gap-4 tablet:grid-cols-3">
          {campaignSuggestions.map((campaign) => {
            ...
            return (
              <div
                key={campaign.id}
                className="rounded-xl border border-peec-border-light bg-white p-5 shadow-card"
              >
